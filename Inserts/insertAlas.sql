...
(4, 'Lavagem e Estética Automotiva', 'Para serviços de lavagem, polimento, cristalizacao, etc.'), 
(5, 'Ala de Diagnóstico', 'Area equipada com scanner automotivo, multimetros e outros aparelhos para fazer diagnosticos iniciais nos veiculos.'),
(6, 'Funilaria e Pintura', 'Voltado para pintura de veiculos e reparo de carroceria'),
(7, 'Ala de Elétrica e Injeção Eletrônica', 'Voltada para diagnostico e reparo de problemas eletricos, sensores, ECU, injecao de combustivel, etc.'),
(8, 'Refeitorio', 'Espaço pequeno com café, salgados ou vending machines para funcionários.'),
